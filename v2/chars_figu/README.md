...
| recurring          | no       | changes status field from 'figurant' to 'figurant-recurring'                                                                                                                   | set to true to make it recurring. All other values will make it not recurring.                    | true                                                                       | true            |
